...
const keyInSwedish = (key: string): string => {
    ...
    return engToSwe[key] || key.split("_").join(" ");
};
                            ...
                            <DialogPanel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                                ...
                                <div className='flex-1 flex flex-col gap-3'>
                                    <div className='relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg'>
                                        ...
                                        {/* <Image src="/ghum.png" alt='car model' fill priority className='object-contain' /> */}
                                    </div>

                                    <div className='flex gap-3'>
                                        <div className='flex-1 relative w-full h-24 bg-primary-green-100 rounded-lg !important'>
                                    ...
                                    <div className="mt-3 flex flex-wrap gap-4">
                                        {Object.entries(car).map(([key, value]) => (
                                            <div className='flex justify-between gap-5 w-full text-right' key={key}>
                                                ...
                                                <p text-black-100 font-semibold>
                                                    {value}
                                                </p>
                                            </div>
                                        ))}
